...
TOTAL_WINDOW_SIZE=int(Hz*1.3)
FINAL_WINDOW_SIZE=int(TOTAL_WINDOW_SIZE//FACTOR)

# in ms
# this has to divide evenly into entire segment (1.3 -> 1300 ms)
PREDICTION_WINDOW=260
...
assert FINAL_WINDOW_SIZE%PREDICTION_WINDOW_SIZE==0
